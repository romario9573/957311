...
const servicesData: Service[] = [
  // СЕРВЕРНАЯ ИНФРАСТРУКТУРА
  {
    ...
    details: "Экономия 5000₽/мес, 152-ФЗ, в 2-3 раза быстрее Cloud.",
    price: "10 000",
    priceUnit: "₽",
  },
  {
    ...
    details: "Для кого: Бизнес с требованиями к локализации данных. Функции: OAuth, Real-time, RLS, S3-хранилище. 152-ФЗ",
    price: "15 000",
    priceUnit: "₽",
  },
  // AI-АГЕНТЫ
  {
    ...
    details: "Применение: Личный помощник, личный ассистент Telegram аккаунта, клиентский сервис, нумеролог, психолог, копирайтер и любые другие роли для самых разных задач. + проверка подписки на канал (если необходимо) и сбор пользователей в базу. Связь с CRM +5000р.",
    price: "от 12 000",
    priceUnit: "₽",
  },
  {
  ...
  },
  {
    ...
    description: "Голосовой AI-агент с человеческой речью для звонков.",
  ...
  },
  {
    ...
    details: "Первое фото - 100 рублей.",
    price: "300",
    priceUnit: "₽/фото",
    bonus: "Два фото в подарок при каждых 15 заказанных фото.",
  },
  {
    id: 19,
    icon: "🎬",
    name: "Создание AI-видео",
    description: "Генерация видео с помощью AI от коротких (8-20 сек) до многоминутных роликов.",
    details: "Идеально для рекламных роликов, контента в соцсети, презентаций продуктов и креативных проектов. Цена зависит от: сложности генерации, количества сцен, монтажа, длительности.",
    price: "от 500",
    priceUnit: "₽",
    priceNote: "За простое 8-секундное видео. Сложные проекты рассчитываются индивидуально.",
  },
  // ВЕБ-РАЗРАБОТКА
  {
    id: 14,
    icon: "🌐",
    name: "Сайт на чистом коде под ключ",
  ...
  // КОНСУЛЬТАЦИИ И ОБУЧЕНИЕ
  {
    ...
    details: "Анализ задач, подбор оптимальных технологий, разработка архитектуры, консультации по внедрению. Подходит для: Компании внедряющие AI, бизнес ищущий точки роста через AI.",
    price: "4 000",
    priceUnit: "₽/час",
  },
  {
    ...
    details: "Индивидуальная программа в зависимости от уровня знаний и потребностей. Практическое обучение работе AI-сервисами, prompt engineering, автоматизация рабочих процессов и создание AI агентов с помощью n8n. Формат: 1 на 1 онлайн, гибкий график.",
    price: "3 000",
    priceUnit: "₽/час",
...
export default function Services() {
  ...
  return (
    <section
      id="services"
      className="services-section pt-24 md:pt-32 pb-12 md:pb-16 px-6 relative"
      ref={ref}
                    ...
                    <div className="service-description">
                      ...
                      {service.bonus && (
                        <div className="service-bonus">
                          <span className="bonus-title">Дополнения:</span>
                          <p>{service.bonus}</p>
                        </div>
                      )}
                    </div>
