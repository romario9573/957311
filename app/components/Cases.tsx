...
const casesData: CaseItem[] = [
  ...
  },
  {
    ...
    tags: ["RAG-системы", "N8N", "API", "AI-фото"],
                ...
                <span className="flex-1 min-w-0">
                  ...
                  {highlightApplied && (
                    <>
                      ...
                      , разработал множество специализированных AI-агентов для разных задач: личный помощник для Telegram-аккаунта, анализ целевой аудитории, сценарист для вирусных видео, автоматизация email-рассылок и многое другое.
                    </>
                  )}
                </span>
              </div>
